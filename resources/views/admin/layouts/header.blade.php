                ...
                <li class="list dropdown-item">
                    ...
                    <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                        <li class="unread status-available">
                            <a href="javascript:;">
                                <div class="user-img">
                                    <img src="{{ asset('/admin/data/profile/avatar-1.png') }}" alt="user-image" class="rounded-circle img-inline">
                                </div>
                                <div>
                                    <span class="name">
                        ...
                        <li class=" status-away">
                            <a href="javascript:;">
                                <div class="user-img">
                                    <img src="{{ asset('/admin/data/profile/avatar-2.png') }}" alt="user-image" class="rounded-circle img-inline">
                                </div>
                                <div>
                                    <span class="name">
                        ...
                        <li class=" status-busy">
                            <a href="javascript:;">
                                <div class="user-img">
                                    <img src="{{ asset('/admin/data/profile/avatar-3.png') }}" alt="user-image" class="rounded-circle img-inline">
                                </div>
                                <div>
                                    <span class="name">
                        ...
                        <li class=" status-offline">
                            <a href="javascript:;">
                                <div class="user-img">
                                    <img src="{{ asset('/admin/data/profile/avatar-4.png') }}" alt="user-image" class="rounded-circle img-inline">
                                </div>
                                <div>
                                    <span class="name">
                        ...
                        <li class=" status-offline">
                            <a href="javascript:;">
                                <div class="user-img">
                                    <img src="{{ asset('/admin/data/profile/avatar-5.png') }}" alt="user-image" class="rounded-circle img-inline">
                                </div>
                                <div>
                                    <span class="name">
